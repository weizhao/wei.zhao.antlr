// $ANTLR 3.3 Nov 30, 2010 12:45:30 ../src/expr/Expr.g 2011-06-01 02:20:39
package expr;
...
public class ExprParser extends Parser {
    ...
    public String getGrammarFileName() { return "../src/expr/Expr.g"; }
    ...
    // $ANTLR start "prog"
    // ../src/expr/Expr.g:12:1: prog : ( stat )+ ;
    public final void prog() throws RecognitionException {
        try {
            // ../src/expr/Expr.g:12:5: ( ( stat )+ )
            // ../src/expr/Expr.g:12:9: ( stat )+
            {
            // ../src/expr/Expr.g:12:9: ( stat )+
            int cnt1=0;
            loop1:
    ...
    // $ANTLR start "stat"
    // ../src/expr/Expr.g:14:1: stat : ( expr NEWLINE | ID '=' expr NEWLINE | NEWLINE );
    public final void stat() throws RecognitionException {
        ...
        try {
            // ../src/expr/Expr.g:14:5: ( expr NEWLINE | ID '=' expr NEWLINE | NEWLINE )
            int alt2=3;
            switch ( input.LA(1) ) {
            case INT:
            case 12:
            ...
            switch (alt2) {
                case 1 :
                    // ../src/expr/Expr.g:14:9: expr NEWLINE
                    {
                    ...
                    break;
                case 2 :
                    // ../src/expr/Expr.g:15:9: ID '=' expr NEWLINE
                    {
    ...
    // $ANTLR start "expr"
    // ../src/expr/Expr.g:20:1: expr returns [int value] : e= multExpr ( '+' e= multExpr | '-' e= multExpr )* ;
    public final int expr() throws RecognitionException {
        ...
        try {
            // ../src/expr/Expr.g:21:5: (e= multExpr ( '+' e= multExpr | '-' e= multExpr )* )
            // ../src/expr/Expr.g:21:9: e= multExpr ( '+' e= multExpr | '-' e= multExpr )*
            {
            ...
            value = e;
            // ../src/expr/Expr.g:22:9: ( '+' e= multExpr | '-' e= multExpr )*
            loop3:
            do {
                int alt3=3;
                ...
                switch (alt3) {
            	case 1 :
            	    // ../src/expr/Expr.g:22:13: '+' e= multExpr
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // ../src/expr/Expr.g:23:13: '-' e= multExpr
            	    {
    ...
    // ../src/expr/Expr.g:27:1: multExpr returns [int value] : e= atom ( '*' e= atom )* ;
    public final int multExpr() throws RecognitionException {
        ...
        try {
            // ../src/expr/Expr.g:28:5: (e= atom ( '*' e= atom )* )
            // ../src/expr/Expr.g:28:9: e= atom ( '*' e= atom )*
            {
    ...
    // $ANTLR start "atom"
    // ../src/expr/Expr.g:31:1: atom returns [int value] : ( INT | ID | '(' expr ')' );
    public final int atom() throws RecognitionException {
        ...
        try {
            // ../src/expr/Expr.g:32:5: ( INT | ID | '(' expr ')' )
            int alt5=3;
            switch ( input.LA(1) ) {
            case INT:
                {
